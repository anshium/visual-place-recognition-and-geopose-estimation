...
class CampusDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            print(f"Error processing image {image_path} with HuggingFace processor: {e}")
            raise
...
class SwinRegressionModel(nn.Module):
    def __init__(self, model_name, dropout_prob=0.3):
        super().__init__()
        print(f"Initializing Swin backbone: {model_name}")
        ...
        print("Using Average Pooling on last_hidden_state.")
